...
public:
    ...
    */
    ...
    /**
      ...
      @see LogMessage for a description of the message decoration.
    */
    virtual void log(const QtMsgType type, const QMessageLogContext&, const QString& message);
...
private:
    ...
    /**
      ...
      @param message Message text
    */
    static void msgHandler(const QtMsgType type, const QMessageLogContext&, const QString& message);
